...
namespace SistemaVentas.Datos
{
    ...
    {
        public static DataSet Autenticar(string sUsuario, string sContrasena)//Editar datos como enteros
        {
            ...
            return DBHelper.ExecuteDataSet("usp_Datos_FUsuario_Autenticar", dbParams);
