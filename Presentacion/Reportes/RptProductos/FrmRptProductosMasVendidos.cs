...
{
    public partial class FrmRptProductosMasVendidos : Form
    {
        public FrmRptProductosMasVendidos()
        {
            InitializeComponent();
        }
        ...
        private void btnGenerar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                rptComprobantes.Load(@"Reportes/ProductosMasVendidos.frx");
                rptComprobantes.Dictionary.Connections[0].ConnectionString = leerConfig.leerValorConfiguracion("connectionString");
                rptComprobantes.SetParameterValue("Titulo", "VENTAS DE  " + leerConfig.leerValorConfiguracion("NombreEmpresa") + " Desde:  " + dtpDesde.Value.Date.ToString("dd/MM/yyyy") + " Hasta: " + dtpHasta.Value.Date.ToString("dd/MM/yyyy"));
